...
function MistakesAndLessons() {
  ...
  return (
    <section data-nav="white" className="relative text-white py-s80 md:py-s160 px-s32  overflow-hidden">
      {/* Grid Background */}
      ...
      <div className="relative z-20 max-w-6xl mx-auto">
        ...
        <div className="grid md:grid-cols-2  gap-s32 md:gap-16 items-center mb-s64 ">
          ...
          <p
            ...
            className="heading-h6 max-w-md animate-xtoright-fadein px-s16"
          >
        ...
        {/* Bottom Row */}
        <div className="grid md:grid-cols-2 gap-s32 md:gap-16 items-center">
          {/* Text */}
          <p
            ref={MistakesAndLessons4.ref}
            className="heading-h6  px-s16 max-w-md md:order-1 order-2 animate-xtoleft-fadein"
          >
