...
function InsightCards({ text }) {
  return (
    <div
      className="
        relative max-w-[320px] h-[150px] rounded-2xl px-6 py-4
      ...
      "
    >
      <span className="absolute left-3 top-4 text-green-400 text-3xl">
        “
      </span>
    ...
    >
      <div className="space-y-s80 md:space-y-s160">
        ...
        <div className="max-w-7xl mx-auto text-center">
          ...
          <div
            className="
              rounded-r24 md:rounded-r32 px-s16
          ...
          >
            <h2
              ref={InsightCard.ref}
              className="
                transition -translate-y-7 sm:-translate-y-15 lg:-translate-y-22
        ...
        <div className="flex flex-col md:flex-row items-center justify-center gap-10">
          {insights?.map((item) => (
            <InsightCards key={item._id} text={item.blog} />
          ))}
        </div>
      </div>
    </section>
